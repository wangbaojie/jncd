...
<script type="text/javascript">
 ...
 foreach($ll as $v){ ?>
  ...
  <div class="sin-a">
    <div class="sin-a-l"><span><?php echo ($Categorys[9][catname]); ?></span></div>
     <div class="sin-1-r"><a href="<?php echo ($Categorys[9][url]); ?>">更多&gt;&gt;</a></div>
  </div>
  <div class="sin-2x">
    <div class="sabout">
   ...
   <div class="sin-1">
      <div class="sin-1-l"><span><?php echo ($Categorys[29][catname]); ?></span></div>
      <div class="sin-1-r"><a href="<?php echo ($Categorys[29][url]); ?>">更多&gt;&gt;</a></div>
    </div>
    <div class="sin-2x">
      <div class="sin-2">
       <?php  $_result=M("Article")->field("*")->where(" 1  AND status=1  AND catid=29")->order("id desc")->limit("4")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><div class="in-10-1"><a href="/wap<?php echo ($r["url"]); ?>"><img src="<?php echo ($r["thumb"]); ?>" width="150" height="110"></a><a href="/wap<?php echo ($r["url"]); ?>"><b><?php echo (str_cut($r["title"],20)); ?></b></a></div><?php endforeach; endif;?>  
