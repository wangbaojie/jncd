...
<script type="text/javascript">
 ...
 foreach($ll as $v){ ?>
  ...
  <div class="sin-2x">
      <div class="sin-2">
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><div class="in-10-1"><a href="/wap<?php echo ($r["url"]); ?>"><img src="<?php echo ($r["thumb"]); ?>" width="150" height="110"></a><a href="/wap<?php echo ($r["url"]); ?>"><b><?php echo (str_cut($r["title"],20)); ?></b></a></div><?php endforeach; endif; else: echo "" ;endif; ?>
