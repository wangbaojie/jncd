    ...
    <?php  $arrparentid = array_filter(explode(',', $Categorys[$catid]['arrparentid'].','.$catid));foreach($arrparentid as $cid):$parsestr[] = '<a href="'.$Categorys[$cid]['url'].'">'.$Categorys[$cid]['catname'].'</a>'; endforeach;echo implode(" &gt; ",$parsestr);?></h1>
            ...
            <div class="ma">
            	<p style="margin-bottom:10px;">
                 ...
                 <div class="fr" style="float: right;color: #5f5e5e;font-size:12px;">上一篇：<a class="pre_a" href="/index.php?m=Article&a=show&id=140">西部超导公司王虹荣获二重万航“突出贡献奖”</a></div> <div class="fl" style="float: left;color: #5f5e5e;font-size:12px;" >下一篇：&nbsp;无</div>
			</div>
        </div>
        <style type="text/css">
		.fr a{
