...
<div id="floor_2_main">
    <div class="title">
        <h2 style="position: relative; left: 0px; opacity: 1;"><a href="">产品中心</a></h2>
        <em style="position: relative; left: 0px; opacity: 1;">product center</em>
        <i style="position: relative; top: 0px; opacity: 1;"></i>
    </div>
    <div id="floor_2">
        <div class="left_body2">
            <div class="hd">
                <div class=" ding"><a href="" title="产品中心"><strong>产品分类</strong>PRODUCTS</a></div>
            ...
            <div class="bd">
                ...
                <dl class="gridlist1">
                    <?php  $_result=M()->query("select * from qswl_page where id=63"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[63][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                 src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[63][catname]); ?></h2>
                            <p> <?php echo (str_cut($r["content"],600)); ?> ......<a href="<?php echo ($Categorys[63][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=64"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[64][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                 src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[64][catname]); ?></h2>
                            <p> <?php echo (str_cut($r["content"],600)); ?> ..... <a href="<?php echo ($Categorys[64][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=66"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[66][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                 src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[66][catname]); ?></h2>
                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[66][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=71"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[71][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                 src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[71][catname]); ?></h2>

                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[71][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=2"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[2][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[2][catname]); ?></h2>
                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[2][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=3"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[3][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[3][catname]); ?></h2>
                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[3][url]); ?>">【查看更多】</a></p>
                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=4"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[4][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[4][catname]); ?></h2>

                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[4][url]); ?>">【查看更多】</a></p>


                        </dd><?php endforeach; endif;?>
                </dl>
                <dl class="gridlist1" style="display: none;">
                    <?php  $_result=M()->query("select * from qswl_page where id=5"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><dt><a href="<?php echo ($Categorys[5][url]); ?>"><img style="width: 415px;height: 415px;"
                                                                src="<?php echo ($r["thumb"]); ?>"></a></dt>
                        <dd>
                            <h2><?php echo ($Categorys[5][catname]); ?></h2>

                            <p> <?php echo (str_cut($r["content"],600)); ?>......<a href="<?php echo ($Categorys[5][url]); ?>">【查看更多】</a></p>
...
<div class="index_awxy" style="opacity: 1;">
    <div class="title">
        <h2 style="position: relative; left: 0px; opacity: 1; "><a href="<?php echo ($Categorys[17][url]); ?>"
                                                                   style="color:#fff">企业简介</a></h2>
        <em style="position: relative; left: 0px; opacity: 1; color:#fff">about us</em>
        <i style="position: relative; top: 0px; opacity: 1; background:#fff"></i>
    </div>
    <div id="floor_3">
        <p style="text-align: center;">
            <?php  $_result=M()->query("select * from qswl_page where id=17"); if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 ); echo (str_cut($r["content"],500)); endforeach; endif;?>
        </p>
        <ul class="zizhi">
            <?php  $_result=M("Article")->field("id,catid,url,title,title_style,keywords,description,thumb,createtime")->where(" 1  AND status=1  AND catid=67")->order("id desc")->limit("5")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li><a href="<?php echo ($Categorys[67][url]); ?>"><img width="170px" height="238px" src="<?php echo ($r["thumb"]); ?>"></a></li><?php endforeach; endif;?>
        </ul>
    </div>
</div>
<div class="index_news">
    <div class="title">
        <h2 style="position: relative; left: 0px; opacity: 1;">
            <a href="<?php echo ($Categorys[8][url]); ?>">新闻资讯</a></h2>
        <em style="position: relative; left: 0px; opacity: 1;">news</em> <i
            style="position: relative; top: 0px; opacity: 1;"></i>
    </div>
    <ul class="menu" style="opacity: 1;">
        <li class="cur"><a href="<?php echo ($Categorys[60][url]); ?>" title="集团动态"> 集团动态</a></li>
        <li class=""><a href="<?php echo ($Categorys[61][url]); ?>" title="行业动态">行业动态</a></li>
        <li class=""><a href="<?php echo ($Categorys[62][url]); ?>" title="专家观点">专家观点</a></li>
        ...
        <div class="newslist">
            ...
            <div class="listbox">
                ...
                <?php  $_result=M("Article")->field("id,catid,url,title,title_style,keywords,description,thumb,createtime")->where(" 1  AND status=1  AND catid=60")->order("id desc")->limit("3")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><div class="list">
                        <img src="/images/news-0<?php echo ($i); ?>.png" alt="<?php echo ($r["title"]); ?>" width="90" height="72">
                        <div class="wen">
...
<div id="link_main">
    <div id="link">
        ...
        <div class="link_body">
            <div class="link_text">
                <ul>
                   <!-- <li><a href="http://www.baidu.com" title="">百度网络</a></li>
                    <li><a href="http://www.baidu.com" title="">百度一下</a></li>-->
                </ul>
            </div>
        </div>
